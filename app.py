...
from dashboard import init_dashboard, add_to_dashboard, render_dashboard

st.set_page_config(layout="wide")
st.title("📊 GenAI Tableau + Dashboard Builder")
...
if file:
    ...
    hue = st.sidebar.selectbox("Hue", ["None"] + columns)
    ...
    if st.button("📊 Generate Chart"):
        ...
        if st.button("🧠 Generate Insights"):
            st.write(parsed.get("insights", "No insights"))
